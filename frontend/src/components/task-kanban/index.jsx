...
const TaskKanban = ({taskCreated}) => {
    ...
    useEffect(() => {
        ...
        async function fetchData(){
            try{
                const response = await Axios.get('/all-tasks', {cancelToken: ourRequest.token})
                const backlogTasks = await Axios.get('/tasks-backlog', {cancelToken: ourRequest.token})
                ...
                const testingTasks = await Axios.get('/tasks-testing', {cancelToken: ourRequest.token})
                const doneTasks = await Axios.get('/tasks-done', {cancelToken: ourRequest.token})
                setTaskState(draft => {
    ...
    function changeStatuss ( statuss, projectId ) {
        ...
        async function updateStatuss(){
            try{
                const response = await Axios.post('/task-statuss-update',{
                    projectId: projectId,
                    statuss: statuss
