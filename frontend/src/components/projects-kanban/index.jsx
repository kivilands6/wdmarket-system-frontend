...
const ProjectsKanban = ({projectCreated}) => {
    ...
    useEffect(() => {
        const ourRequest = Axios.CancelToken.source()
            ...
            async function fetchData(){
                try{
                    const response = await Axios.get('/all-projects', {cancelToken: ourRequest.token})
                    const newProjects = await Axios.get('/projects-new', {cancelToken: ourRequest.token})
                    const inProgressProjects = await Axios.get('/projects-inprogress', {cancelToken: ourRequest.token})
                    const completedProjects = await Axios.get('/projects-completed', {cancelToken: ourRequest.token})
    ...
    function changeStatuss ( statuss, projectId ) {
        ...
        async function updateStatuss(){
            try{
                const response = await Axios.post('/project-statuss-update',{
                    projectId: projectId,
                    statuss: statuss
